...
4. Call `brain_templates` to see what templates are available, then call `brain_create(template, title)` using an exact template name from that list — note the returned filepath
