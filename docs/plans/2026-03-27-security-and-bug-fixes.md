...
```bash
cd /Users/user/projects/second-brain && pytest tests/lib/test_db.py::test_init_db_rejects_non_positive_dim tests/lib/test_db.py::test_init_db_rejects_negative_dim -v
```
