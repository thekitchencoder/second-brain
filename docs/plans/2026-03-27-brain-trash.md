...
```bash
cd /Users/user/projects/second-brain && pytest tests/lib/test_db.py::test_delete_file_chunks_removes_chunks_and_embeddings tests/lib/test_db.py::test_delete_file_chunks_does_not_affect_other_filepaths -v
```
...
```bash
cd /Users/user/projects/second-brain && pytest tests/lib/test_db.py -v
```
...
```bash
cd /Users/user/projects/second-brain && pytest tests/test_brain_service.py -k "trash or restore" -v
```
...
```bash
cd /Users/user/projects/second-brain && pytest tests/test_brain_service.py -v
```
...
```bash
cd /Users/user/projects/second-brain/tools && python -c "from brain_mcp_server import _build_server; s = _build_server(); print('OK')"
```
...
```bash
cd /Users/user/projects/second-brain && pytest tests/test_brain_api.py::test_trash_note tests/test_brain_api.py::test_restore_note -v
```
...
```bash
cd /Users/user/projects/second-brain && pytest tests/test_brain_api.py -v
```
...
```bash
cd /Users/user/projects/second-brain && pytest tests/test_brain_index.py::test_watch_filter_excludes_trash_paths -v
```
...
```bash
cd /Users/user/projects/second-brain && pytest tests/test_brain_index.py -v
```
...
```bash
cd /Users/user/projects/second-brain && pytest tests/lib/test_db.py tests/lib/test_edit.py tests/lib/test_config.py tests/test_brain_service.py tests/test_brain_index.py -v
```
